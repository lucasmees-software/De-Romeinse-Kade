document.addEventListener("DOMContentLoaded", function () {
  ...
  popup.innerHTML = `
        ...
        <div class="rk-popup-panel" role="dialog" aria-modal="true" aria-label="Order menu">
            ...
            <div class="rk-popup-footer">
                <a href="/De-Romeinse-Kade/dakotah/pages/menu.php" class="rk-popup-menu-btn">
                    ← Voeg meer items toe
                </a>
            </div>
        </div>
  ...
  function loadOrder() {
    ...
    fetch("/De-Romeinse-Kade/dakotah/pages/get_order.php")
      .then((r) => r.json())
      .then((items) => {
        // Empty cart
        if (items.length === 0) {
  ...
  window.changeQty = function (btn, delta) {
    ...
    fetch("/De-Romeinse-Kade/dakotah/pages/update_order.php", {
      method: "POST",
